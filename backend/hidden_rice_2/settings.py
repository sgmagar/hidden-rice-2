"""
Django settings for hidden_rice_2 project.
...
ROOT_URLCONF = 'hidden_rice_2.urls'
...
WSGI_APPLICATION = 'hidden_rice_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_rice_2 API",
    "DESCRIPTION": "API documentation for hidden_rice_2 App",
    "VERSION": "v1",
}
